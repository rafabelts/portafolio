    ...
    render() {
        return (
            <header id="presentation" className="flex flex-col py-24 gap-14 lg:fixed lg:w-1/2 lg:min-h-screen lg:justify-between">
                ...
                <a href="mailto:rafaelbeltraans@gmail.com" className="flex flex-row justify-start items-center gap-5 bg-container px-2 py-2 lg:px-4 lg:py-4 w-fit rounded-2xl hover:shadow-sm hover:shadow-white ">
