...
const projectsData: Data = {
    "OctoConta": {
        ...
        about:
            <p className="text-textColor text-xl text-justify">
    ...
    "MealPal": {
        ...
        about:
            <div className="text-textColor text-xl text-justify">
    ...
    return (
        <>
            <li id="schoolTitle" className="relative hover:!opacity-100 group-hover/list:opacity-15 mb-12 cursor-pointer" onClick={() => setIsOpen(true)}>
                <center>
                    <Image src={image} className="rounded-xl opacity-90 h-[20%] w-[60%]" alt={image} width={450} height={450} />
    ...
    render() {
        return (
            <div id="projectList" className="flex flex-col gap-5">
                <h2 className="text-[40px] font-bold text-textColor mb-2"> Things I&apos;ve built </h2>
